...
class WriteActivityToolbarExtension:
    ...
    def __init__(self, activity, toolbox, abiword_canvas, parent):
...
class WriteEditToolbar(EditToolbar):
	...
	####btn salir del barrido del menu item
        ...
        self._btn_barrido_menu_id = self._btn_barrido_menu.connect('clicked', self._btn_barrido_menu_cb)
...
class ViewToolbar(gtk.Toolbar):
    def __init__(self, abiword_canvas, mi_teclado, parent):
        gtk.Toolbar.__init__(self)
	...
	# teclado en pantalla
        ...
        separator_2.show()
        self.insert(separator_2, -1)

	self._mi_teclado = mi_teclado

        self._btn_mostrarTP = ToolButton()
        self._btn_mostrarTP.set_tooltip(_('Mostrar \nTeclado'))
        self._btn_mostrarTP_id = self._btn_mostrarTP.connect('clicked', self._btn_mostrarTP_cb)
        self.insert(self._btn_mostrarTP, -1)
        self._btn_mostrarTP.show()

        self._btn_ocultarTP = ToolButton()
        self._btn_ocultarTP.set_tooltip(_('Ocultar \nTeclado'))
        self._btn_ocultarTP_id = self._btn_ocultarTP.connect('clicked', self._btn_ocultarTP_cb)
        self.insert(self._btn_ocultarTP, -1)
        self._btn_ocultarTP.show()
    ...
    def _btn_mostrarTP_cb(self, button):
	self._mi_teclado.show_all()

    def _btn_ocultarTP_cb(self, button):
	self._mi_teclado.hide_all()
